...
#SBATCH --output=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_audio_resnet50_%j.out
#SBATCH --error=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_audio_resnet50_%j.err
...
"$PY" run_vggsound_full_audio_resnet50_bm.py \
  --root "$ROOT" \
  --python_bin "$PY" \
