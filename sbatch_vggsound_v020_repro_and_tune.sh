...
#SBATCH --output=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_v020_repro_tune_%j.out
#SBATCH --error=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_v020_repro_tune_%j.err
...
"${PYTHON_BIN}" -u run_vggsound_v020_repro_and_tune.py \
  --root . \
