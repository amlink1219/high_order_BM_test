#!/usr/bin/env bash
#SBATCH --job-name=vgg-af017-long
...
#SBATCH --output=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_audio_cnn_lstm_af017_long_%j.out
#SBATCH --error=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_audio_cnn_lstm_af017_long_%j.err
...
"$PY" run_vggsound_full_audio_cnn_lstm_af017_longer.py \
  --root "$ROOT" \
  --python_bin "$PY" \
