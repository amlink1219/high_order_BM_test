...
BASE_EXPERIMENT = {
    ...
    "out_dir": "runs_vggsound_full_VF003_video_resnet50_meanstd_f16_h4_lc5",
}
...
EXPERIMENTS: List[Dict] = [
    {
        "id": "VF005",
        "name": "video_resnet50_meanstd_f16_h4_lc5_resume120",
        "hidden_factor": 4.0,
        "label_copies": 5,
        "epochs": 120,
        "batch_size": 128,
    ...
    {
        "id": "VF006",
        "name": "video_resnet50_meanstd_f16_h4_lc5_resume180",
        "hidden_factor": 4.0,
        "label_copies": 5,
        "epochs": 180,
        "batch_size": 128,
    ...
    {
        "id": "VF007",
        "name": "video_resnet50_meanstd_f16_h6_lc5_e120",
        "hidden_factor": 6.0,
        "label_copies": 5,
        "epochs": 120,
        "batch_size": 96,
    ...
    {
        "id": "VF008",
        "name": "video_resnet50_meanstd_f16_h8_lc5_e120",
        "hidden_factor": 8.0,
        "label_copies": 5,
        "epochs": 120,
        "batch_size": 64,
...
def source_dir_for(root: Path, exp: Dict) -> Path | None:
    ...
    if not ref:
        return None
    if ref == "VF003":
        return root / BASE_EXPERIMENT["out_dir"]
...
def write_log(root: Path, results: List[Dict]) -> None:
    ...
    (root / "vggsound_full_f16_followup_log.md").write_text(text, encoding="utf-8")


def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Run f16 follow-up experiments for full VGGSound visual BM.")
...
def main() -> None:
    ...
    write_log(root, results)
    print("VGGSound full f16 follow-up finished.", flush=True)
