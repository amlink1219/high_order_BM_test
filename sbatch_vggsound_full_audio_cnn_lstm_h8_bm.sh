...
#SBATCH --output=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_audio_cnn_lstm_h8_%j.out
#SBATCH --error=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_audio_cnn_lstm_h8_%j.err
...
"$PY" run_vggsound_full_audio_cnn_lstm_h8_bm.py \
  --root "$ROOT" \
  --python_bin "$PY" \
