...
#SBATCH --output=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_video4x5x_audio_cnn_bm_%j.out
#SBATCH --error=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_video4x5x_audio_cnn_bm_%j.err
...
"${PYTHON_BIN}" -u run_vggsound_video4x5x_audio_cnn_bm.py \
  --root . \
