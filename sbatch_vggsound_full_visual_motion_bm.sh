#!/bin/bash
#SBATCH --job-name=vgg-full-visbm
...
#SBATCH --output=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_full_visual_motion_bm_%j.out
#SBATCH --error=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_full_visual_motion_bm_%j.err
...
"${PYTHON_BIN}" -u run_vggsound_full_visual_motion_bm.py \
  --root . \
