...
LONGER_EXPERIMENTS: List[Dict] = [
    {
        "id": "AF018",
        "name": "standard_audio_cnnlstm4096_h6_lc5_e500_resume_af017",
        "epochs": 500,
        "resume_from": "runs_vggsound_full_AF017_standard_audio_cnnlstm4096_h6_lc5_e300_resume_af016",
    },
    {
        "id": "AF019",
        "name": "standard_audio_cnnlstm4096_h6_lc5_e700_resume_af018",
        "epochs": 700,
        "resume_from": "runs_vggsound_full_AF018_standard_audio_cnnlstm4096_h6_lc5_e500_resume_af017",
    },
]
...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Continue AF017 audio CNN-LSTM BM to longer epochs.")
    ...
    p.add_argument("--only_e700", action="store_true")
...
def main() -> None:
    ...
    experiments = LONGER_EXPERIMENTS
    if args.only_e500:
        experiments = [e for e in experiments if e["id"] == "AF018"]
    if args.only_e700:
        experiments = [e for e in experiments if e["id"] == "AF019"]
    results: List[Dict] = []
    ...
    update_status(root, results)
    print("AF017 longer continuation finished.", flush=True)
