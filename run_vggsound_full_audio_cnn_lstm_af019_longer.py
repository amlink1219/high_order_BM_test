...
EXPERIMENTS: List[Dict] = [
    {
        "id": "AF022",
        "name": "standard_audio_cnnlstm4096_h6_lc5_e900_resume_af019",
        "epochs": 900,
        "resume_from": "runs_vggsound_full_AF019_standard_audio_cnnlstm4096_h6_lc5_e700_resume_af018",
    },
    {
        "id": "AF023",
        "name": "standard_audio_cnnlstm4096_h6_lc5_e1000_resume_af022",
        "epochs": 1000,
        "resume_from": "runs_vggsound_full_AF022_standard_audio_cnnlstm4096_h6_lc5_e900_resume_af019",
    },
]
...
def append_status(root: Path, results: List[Dict]) -> None:
    ...
    lines = [
        "",
        "## AF019 Longer Continuation Pending/Result",
        "",
...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Continue AF019 audio CNN-LSTM BM to e900/e1000.")
    ...
    p.add_argument("--only_e900", action="store_true")
    p.add_argument("--only_e1000", action="store_true")
...
def main() -> None:
    ...
    if args.only_e900:
        experiments = [e for e in experiments if e["id"] == "AF022"]
    if args.only_e1000:
        experiments = [e for e in experiments if e["id"] == "AF023"]
    results: List[Dict] = []
    ...
    append_status(root, results)
    print("AF019 longer continuation finished.", flush=True)
