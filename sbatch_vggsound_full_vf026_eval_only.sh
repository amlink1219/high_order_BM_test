#!/usr/bin/env bash
#SBATCH --job-name=vgg-vf026-eval
...
#SBATCH --output=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_vf026_eval_only_%j.out
#SBATCH --error=/home/Hongjie_Zeng/high_order_BM/logs/vggsound_vf026_eval_only_%j.err
...
"$PY" run_vggsound_full_vf026_eval_only.py \
  --root "$ROOT" \
  --python_bin "$PY" \
